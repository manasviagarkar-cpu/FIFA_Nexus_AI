...
export type TranslationContext = 'stadium_navigation' | 'food_order' | 'merchandise' | 'emergency' | 'general_inquiry' | 'match_information' | 'transportation' | 'medical';
...
/** Query categories */
export type QueryCategory = 'facilities' | 'schedule' | 'food_beverage' | 'transportation' | 'rules_policies' | 'accessibility' | 'emergency' | 'entertainment' | 'general';
...
//# sourceMappingURL=fan-assistance.d.ts.map